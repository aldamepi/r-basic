...
#¿Cuantas semanas hay en 725 días?
725%/%7
...
#multiplicando por pi y dividiendo por 180 se transforma de sexagesimal a radianes
...
sinpi(1/2) # = sin (pi/2); el argumento es un multiplo de pi
...
#R trabaja con 16 decimales,si se le piden más se equivoca
...
#el nombre de la variable es muda
...
Re(complex(modulus = 5,argument = pi/6))
